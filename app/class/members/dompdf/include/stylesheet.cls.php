...
//    }
    ...
    foreach ( $matches as $match ) {
      ...
      if ( $match[2] !== "" ) {
        ...
        case "page":
          ...
          if ( is_empty($this->_page_styles[$key]) ) {
  ...
  private function _parse_import($url) {
    ...
    if ( $accept ) {
      ...
      // Todo: As above, do we need to replace php or file to an is_empty protocol for local files?
